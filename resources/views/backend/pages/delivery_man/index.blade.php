                    ...
                    <form action="{{ route('admin.delivery-men.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Jhon Doe" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" name="email" class="form-control" placeholder="jhon@link.com" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Phone</label>
                                <input type="text" name="phone" class="form-control" placeholder="017..." required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">NID Number</label>
                                <input type="text" name="nid_number" class="form-control" placeholder="Digit ID" required>
                            </div>
                ...
                <form method="GET" action="{{ route('admin.delivery-men.index') }}">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="name" value="{{ request('name') }}" class="form-control" placeholder="Type name...">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="from_date" value="{{ request('from_date') }}" class="form-control datepicker" placeholder="YYYY-MM-DD">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">To Date</label>
                            <input type="text" name="to_date" value="{{ request('to_date') }}" class="form-control datepicker" placeholder="YYYY-MM-DD">
                        </div>
                        <div class="col-md-2 d-flex gap-2">
                            <button type="submit" class="btn btn-search flex-grow-1 shadow-sm">Search</button>
                            <a href="{{ route('admin.delivery-men.index') }}" class="btn-reset border shadow-sm" title="Clear Filters">
                                🔄
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="small">{{ $man->nid_number }}
                                <div class="small text-muted">{{ $man->address }}</div>
                                </td>
                                <td class="small">{{ $man->note }}
                                <td>
                                    @if($man->status)
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ route('admin.delivery-men.status', $man->id) }}" method="POST">
                                            @csrf @method('PATCH')
                                            <button class="btn-icon btn-status" title="Toggle Status">⚡</button>
                                        </form>
                                        <a href="{{ route('admin.delivery-men.edit', $man->id) }}" class="btn-icon btn-edit">✏️</a>
                                        <form action="{{ route('admin.delivery-men.delete', $man->id) }}" method="POST" onsubmit="return confirm('Delete this record?')">
                                            @csrf @method('DELETE')
