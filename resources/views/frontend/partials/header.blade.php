    ...
    <nav class="navbar navbar-expand-lg custom_nav-container ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto ">
          ...
          {{-- AUTH SECTION (GUARD BASED – CORRECTED) --}}
          @auth('frontend')

            <li class="nav-item">
              <a class="nav-link text-warning" href="{{ route('profile') }}">
                {{ Auth::guard('frontend')->user()->full_name }}
              </a>
            </li>
              ...
              <g>
                <g>
                  <path d="M439.296,84.91c-1.024,0-2.56-0.512-4.096-0.512H112.64
                    ...
                    C9.216,10.67,0,19.886,0,31.15c0,11.264,9.216,20.48,20.48,20.48
                    h41.472c2.56,0,4.608,2.048,5.12,4.608l31.744,216.064
